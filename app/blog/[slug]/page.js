...
const defaultAuthor = {
  ...
  authorBio:
    "ডাঃ নাজনীন আক্তার একজন শিশুরোগ বিশেষজ্ঞ, যিনি বাংলাদেশের বিভিন্ন হাসপাতালে ১০ বছরেরও বেশি সময় ধরে কাজ করছেন।",
};

const defaultRelatedPost = {
  relatedPosts: [
    {
...
export default function BlogPost() {
  ...
  let post = blogPosts.filter( blog => blog.slug == slug);
  ...
  // if post then include default AUTHOR and REALATED POST
      ...
      <main className="min-h-screen pt-8 pb-16">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <Link
              href="/blog"
              className="text-sm text-pink-600 hover:text-pink-700 inline-flex items-center mb-4"
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <Button
                    ...
                    size="sm"
                    className={
                      isLiked ? "text-pink-600 border-pink-200 bg-pink-50" : ""
                    }
                    onClick={handleLike}
                  >
                    <Heart
                  ...
                  <Button
                    ...
                    onClick={handleSave}
                    className={
                      isSaved ? "text-pink-600 border-pink-200 bg-pink-50" : ""
                    }
                  >
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  <Link href="/category/baby-care">
                    <Badge
                      variant="outline"
                      className="bg-gray-50 hover:bg-pink-50 text-gray-700 hover:text-pink-700"
                    >
                      শিশুর যত্ন
                    </Badge>
                  </Link>
                    ...
                    .map((popularPost, index) => (
                      <div key={index} className="flex space-x-3">
                        ...
                        <div className="flex-1">
                          <Link
                            href={`/blog/${Object.keys(blogPosts)[index]}`}
                            className="font-medium text-sm text-gray-900 hover:text-pink-600 line-clamp-2"
                          >
                            {popularPost.title}
                          </Link>
